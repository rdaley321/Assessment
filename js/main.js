...
/*************************************************************************************
------------ ANSWER -------------------
//No, x is a global variable
//No, y is a local variable
//console.log(y) would return undefined because y is local to scopeThis()
//console.log(x) would return "I'm a local variable" because it global to scopeThis()
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
//console.log(x) would return undefined because it is logged before it is assigned
//console.log(foo) would return "function hoisting" because it is hoisted above the console.log
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
//console.log inside the IFEE would print 4 because it is inside the function
//console.log outside the IFEE would print undefined because add is local to inside the function
**************************************************************************************/
